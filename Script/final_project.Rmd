...
```{r,eval=TRUE}
bestmodel<-load("./Rdata/b_aic_stepwise.RData")
```
...
```{r,eval=TRUE}
bestmodel<-load("./Rdata/c_aic_stepwise.RData")
```
...
```{r,eval=TRUE}
bestmodel<-load("./Rdata/combine_aic_stepwise.RData")
```
...
```{r,eval=TRUE}
bestmodel<-load("./Rdata/b_aic_forward_t.RData")
```
...
```{r,eval=TRUE}
bestmodel<-load("./Rdata/c_aic_stepwise_t.RData")
```
...
```{r,eval=TRUE}
bestmodel<-load("./Rdata/combine_aic_forward_t.RData")
```
