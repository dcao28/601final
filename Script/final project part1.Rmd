...
save(set_b_log,file = "../data/set_b_log.RData")
...
b_lasso_cv = cv.glmnet(model.matrix(b_aic_stepwise)[,-1], set_b_log$y, lambda = grid)
b_lasso = glmnet(model.matrix(b_aic_stepwise)[,-1], set_b_log$y, lambda = b_lasso_cv$lambda.min)
summary(b_lasso)
...
b_lasso_cv$cvm[which(b_lasso_cv$lambda == b_lasso_cv$lambda.min)]
b_lasso_fitted_value = model.matrix(b_aic_stepwise)[,-1] %*% b_lasso$beta
plot(b_lasso_fitted_value, b_lasso_fitted_value - set_b_log$y, main = "Residuals vs Fitted (Set B, response, LASSO)", xlab = "Fitted values", ylab = "Residuals")
vif(b_lasso)

save(b_bic_backward, file = "b_bic_backward.RData")
```
...
save(set_c_log,file = "../data/set_c_log.RData")
...
## LASSO
c_lasso_cv = cv.glmnet(model.matrix(c_aic_stepwise)[,-1], set_c_log$y, lambda = grid)
c_lasso = glmnet(model.matrix(c_aic_stepwise)[,-1], set_c_log$y, lambda = c_lasso_cv$lambda.min)
summary(c_lasso)

## Comparing CV
mean((c_aic_forward_cv$cvpred-c_aic_forward_cv$y)^2)
mean((c_aic_backward_cv$cvpred-c_aic_backward_cv$y)^2)
mean((c_aic_stepwise_cv$cvpred-c_aic_stepwise_cv$y)^2) # best
mean((c_bic_forward_cv$cvpred-c_bic_forward_cv$y)^2)
mean((c_pcr_cv$cvpred-c_pcr_cv$y)^2)
mean((c_pls_cv$cvpred-c_pls_cv$y)^2)
c_lasso_cv$cvm[which(c_lasso_cv$lambda == c_lasso_cv$lambda.min)]

# c_aic_forward and c_aic_stepwise have the same CV.  However, c_aic_stepwise has larger adj R-squared.(0.137)

c_lasso_fitted_value = model.matrix(c_aic_stepwise)[,-1] %*% c_lasso$beta
plot(c_lasso_fitted_value, c_lasso_fitted_value - set_c_log$y, main = "Residuals vs Fitted (Set C, response, LASSO)", xlab = "Fitted values", ylab = "Residuals")

save(c_bic_forward, file = "c_bic_forward.RData")
```
...
save(set_b_t,file = "../data/set_b_t.RData")
...
## LASSO
b_lasso_cv_t = cv.glmnet(model.matrix(b_aic_forward_t)[,-1], set_b_t$TP53, lambda = grid)
b_lasso_t = glmnet(model.matrix(b_aic_forward_t)[,-1], set_b_t$TP53, lambda = b_lasso_cv_t$lambda.min)
summary(b_lasso_t)
...
b_lasso_cv_t$cvm[which(b_lasso_cv_t$lambda == b_lasso_cv_t$lambda.min)]
b_lasso_fitted_value_t = model.matrix(b_aic_forward_t)[,-1] %*% b_lasso_t$beta
plot(b_lasso_fitted_value_t, b_lasso_fitted_value_t - set_b_t$TP53, main = "Residuals vs Fitted (Set B, TP53, LASSO)", xlab = "Fitted values", ylab = "Residuals")

save(b_bic_backward_t,file = "b_bic_backward_t.RData")
```
...
save(set_c_t,file = "../data/set_c_t.RData")
## fitting full model
...
# cv becomes larger. I finally choose c_aic_stepwise_t.

## LASSO
c_lasso_cv_t = cv.glmnet(model.matrix(c_aic_stepwise_t)[,-1], set_c_t$TP53, lambda = grid)
c_lasso_t = glmnet(model.matrix(c_aic_stepwise_t)[,-1], set_c_t$TP53, lambda = c_lasso_cv_t$lambda.min)
summary(c_lasso_t)

## Comparing CV
mean((c_aic_forward_cv_t$cvpred-c_aic_forward_cv_t$TP53)^2)
mean((c_aic_backward_cv_t$cvpred-c_aic_backward_cv_t$TP53)^2)
mean((c_aic_stepwise_cv_t$cvpred-c_aic_stepwise_cv_t$TP53)^2) # best
...
mean((c_pls_cv_t$cvpred-c_pls_cv_t$TP53)^2)
c_lasso_cv_t$cvm[which(c_lasso_cv_t$lambda == c_lasso_cv_t$lambda.min)] # this is larger than the original model without CV
c_lasso_fitted_value_t = model.matrix(c_aic_stepwise_t)[,-1] %*% c_lasso_t$beta
plot(c_lasso_fitted_value_t, c_lasso_fitted_value_t - set_c_t$TP53, main = "Residuals vs Fitted (Set C, TP53, LASSO)", xlab = "Fitted values", ylab = "Residuals")

save(c_bic_backward_t, file = "c_bic_backward_t.RData")
...
save(set_combine_log,file = "../data/set_combine_log.RData")
...
## LASSO
combine_lasso_cv = cv.glmnet(model.matrix(combine_aic_stepwise)[,-1], set_combine_log$y, lambda = grid)
combine_lasso = glmnet(model.matrix(combine_aic_stepwise)[,-1], set_combine_log$y, lambda = combine_lasso_cv$lambda.min)
...
combine_lasso_cv$cvm[which(combine_lasso_cv$lambda == combine_lasso_cv$lambda.min)]# this is larger than the original model without CV
combine_lasso_fitted_value = model.matrix(combine_aic_stepwise)[,-1] %*% combine_lasso$beta
plot(combine_lasso_fitted_value, combine_lasso_fitted_value - set_combine_log$y, main = "Residuals vs Fitted (Combine, response, LASSO)", xlab = "Fitted values", ylab = "Residuals")

save(combine_bic_forward, file = "combine_bic_forward.RData")
```
...
save(set_combine_t,file = "../data/set_combine_t.RData")
...
## LASSO
combine_lasso_cv_t = cv.glmnet(model.matrix(combine_aic_forward_t)[,-1], set_combine_t$TP53, lambda = grid)
combine_lasso_t = glmnet(model.matrix(combine_aic_stepwise_t)[,-1], set_combine_t$TP53, lambda = combine_lasso_cv_t$lambda.min)
summary(combine_lasso_t)
combine_lasso_fitted_value_t = model.matrix(combine_aic_forward_t)[,-1] %*% combine_lasso_t$beta
plot(combine_lasso_fitted_value_t, combine_lasso_fitted_value_t - set_combine_t$TP53, main = "Residuals vs Fitted (Combine, TP53, LASSO)", xlab = "Fitted values", ylab = "Residuals")
...
combine_lasso_cv_t$cvm[which(combine_lasso_cv_t$lambda == combine_lasso_cv_t$lambda.min)]


save(combine_bic_backward_t, file = "combine_bic_backward_t.RData")
```
