...
cat("begin gmc forward selection in Set.B.Log with G1\n")
...
cat("begin gmc forward selection in Set.B.Log with G2\n")
pre.m <- lm(y ~ 1, data = set_b_log)
stepBestGLM<- vector(mode="list")
stepBestLM <- vector(mode="list")
gmcs <- c()
...
# }
# 
# cat("begin gmc forward selection in Set.B.Log with G3 \n")
# pre.m <- lm(y ~ 1, data = set_b_log)
# stepBestGLM<- vector(mode="list")
# stepBestLM <- vector(mode="list")
# gmcs <- c()
...
# }
# 
# cat("begin gmc forward selection in Set.B.Log with G4\n")
# pre.m <- lm(y ~ 1, data = set_b_log)
# stepBestGLM<- vector(mode="list")
# stepBestLM <- vector(mode="list")
# gmcs <- c()
